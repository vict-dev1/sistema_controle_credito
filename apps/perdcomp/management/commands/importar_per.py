...
from perdcomp.models import PER, Empresa
import fitz
import os
import re
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=str,
            required=True,
            help="Caminho do diretório contento os arquivos PDF para processamento."
        )
    ...
    def read_pdfs_in_directory(self,directory_path):
        ...
        try:
            for filename in os.listdir(directory_path):
                if filename.endswith('.pdf') and "PER" in filename and "DECLARAÇÃO" in filename:
